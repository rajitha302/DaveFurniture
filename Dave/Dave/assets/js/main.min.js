    ...
    var t = {
        ...
        stickyHeader: function() {
            if (e(".sticky-header").length) {
                ...
                if (!e(".header-bottom").find(".logo").length) {
                    ...
                    e(".header-middle").find(".header-right").clone(!0).appendTo(t);
                    var i = e(".header").find(".logo").clone(!0);
                    i.children().attr("src", "assets/images/Dave-Furnitures-logo.svg"), i.prependTo(t)
                }
            }
        ...
        owlCarousels: function() {
            ...
            i.owlCarousel(e.extend(!0, {}, t, {
                ...
                o.children(".active").removeClass("active"), o.children("li:nth-child(" + ((e.item.index + 1) % 3 + 1) + ")").addClass("active")
            }), e(".home-slider-sidebar li").on("click", function(t) {
                if (!e(this).hasClass("active")) {
                    var i = e(this).index();
                    e(".home-slider").trigger("to.owl.carousel", [i, 300, !0])
                }
...
function(e) {
    ...
    e.isFunction(e.fn.themePluginCountdown) && e(function() {
        e("[data-plugin-countdown]:not(.manual), .countdown").each(function() {
            var t, i = e(this),
                o = theme.fn.getOptions(i.data("plugin-options"));
            o && (t = o), i.themePluginCountdown(t)
        })
    })
}.apply(this, [jQuery]);