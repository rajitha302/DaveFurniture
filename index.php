...
<body>
    <div class="page-wrapper">
                ...
                <div class="container">
                    <div class="header-left">
                        ...
                        <a href="index-2.html" class="logo">
                            <img src="assets/images/Dave-Furnitures-logo.svg" alt="Porto Logo">
                        </a>
                    </div>
                    <!-- End .header-left -->
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-lg-6">
                                                    ...
                                                    <ul>
                                                        ...
                                                        <li><a href="category.html">4 Columns Products <span
        ...
        <main class="main home">
            ...
            <section class="home-products-intro" id="specialOffer" style="padding: 4.5rem 0 2rem;">
                <div class="container">
                    <div class="row">
                        <div class="col-xl-3">
                        ...
                        <div class="col-xl-9">
                            <div class="home-product-tabs">
                                <ul class="nav nav-tabs mb-3" role="tablist">
                                    <li class="nav-item">
                                        <a class="nav-link active" id="best-sellers-tab" data-toggle="tab" href="#best-sellers" role="tab" aria-controls="best-sellers" aria-selected="true">Office</a>
                                    </li>
                                    <li class="nav-item">
                                        <a class="nav-link" id="audio-speakers-tab" data-toggle="tab" href="#audio-speakers" role="tab" aria-controls="audio-speakers" aria-selected="false">Living Room</a>
                                    </li>
                                    <li class="nav-item">
                                        <a class="nav-link" id="cameras-tab" data-toggle="tab" href="#cameras" role="tab" aria-controls="cameras" aria-selected="false">Dinning Room</a>
                                    </li>
                                    <li class="nav-item">
                                        <a class="nav-link" id="lamps-tab" data-toggle="tab" href="#lamps" role="tab" aria-controls="lamps" aria-selected="false">Outdoor</a>
                                    </li>
                                    <li class="nav-item">
                                        <a class="nav-link" id="computer-tab" data-toggle="tab" href="#computer" role="tab" aria-controls="computer" aria-selected="false">Other</a>
                                    </li>
                                </ul>
                                ...
                                <div class="tab-content">
                                    <div class="tab-pane fade show active" id="best-sellers" role="tabpanel" aria-labelledby="best-sellers-tab">
                                        <div class="product-card-size">
                                            <div class="m-3 product-default inner-quickview inner-icon" style="background: #F4F4F4; border-radius: 8px;">
                                                <figure>
                                                    <a href="product.html">
        ...
        <footer class="footer">
            ...
            <div class="container">
                <div class="footer-middle   ">
                    <div class="row">
                        <a href="index-2.html">
                            <img src="assets/images/Dave-Furnitures-logo.svg" alt="Porto Logo" class="mt-2">
                        </a>
                        <div class="row">
